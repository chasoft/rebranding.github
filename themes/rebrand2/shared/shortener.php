      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" data-toggle="datepicker" name="expiry" id="expiry" placeholder="<?php echo e("DD/MM/YYYY") ?>" autocomplete="off">
          </div>
          <p style="padding-top: 10px;"><?php echo e('Set an expiration date to disable the URL after this date.') ?></p>
        </div>
        <!-- /.col-md-3 -->
        <div class="col-md-3 col-sm-6">
          ...
          <p style="padding-top: 10px;"><?php echo e('By adding a password, you can restrict the access.') ?></p>
        </div>
        <!-- /.col-md-3 -->
        <div class="col-md-3 col-sm-6">
          ...
          <p style="padding-top: 10px;"><?php echo e('This can be used to identify URLs on your account.') ?></p>
        </div>
        <!-- /.col-md-3 -->
      </div>
      <!--/.row -->
