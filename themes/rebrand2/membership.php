  	...
  	<?php echo $this->sidebar() ?>  	
		<!-- </php if($this->pro() && !$this->isTeam()) : /> -->
			<div class="panel panel-default panel-body">
				...
				<p><strong><?php echo e("Expiry") ?></strong>: <span style="color: #c3463c;"><?php echo date("F d, Y", strtotime($this->user->expiration)) ?></span></p>
	       ...
	       <div class="member-stats">
					<p><span><?php echo e("Used")?> <?php echo $this->count("user_urls") ?> <?php echo e("out of")?> <?php echo ($this->user->plan->numurls > 0 ? $this->user->plan->numurls : e("Unlimited")) ?></span> <?php echo e('URLs') ?></p>
