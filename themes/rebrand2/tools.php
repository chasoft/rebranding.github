        ...
        <div class="tabbed" id="quick">
          <div class="panel panel-default">
            <div class="panel-body text-justify">
              ...
              <pre class="code"><span><?php echo Main::href("q/?u=https://www.google.com") ?></span><span><?php echo Main::href("q/?u=anh.pw") ?></span><span><?php echo Main::href("q/?u=http://www.apple.com/iphone-7/") ?></span></pre>
        ...
        <div class="tabbed" id="bk">
          <div class="panel panel-default">
            <div class="panel-body text-justify">
              ...
              <span class="d-flex justify-content-center"><a class='btn btn-secondary' href="javascript:void((function () {var h = '<?php echo $this->config["url"] ?>';if (h.indexOf('http:') >= 0 && window.location.protocol == 'https:') {window.location = h+'/?bookmark=1&token=<?php echo md5($this->config["public_token"]) ?>&amp;url=' + encodeURIComponent(document.URL);} else {var e = document.createElement('script');e.setAttribute('data-url', h);e.setAttribute('data-token', '<?php echo md5($this->config["public_token"]) ?>');e.setAttribute('id', 'gem_bookmarklet');e.setAttribute('type', 'text/javascript');e.setAttribute('src', h+'/static/bookmarklet.js?v=<?php echo time() ?>');document.body.appendChild(e);}})());" rel='nofollow' title='<?php echo e('Drag me to your Bookmark Bar') ?>' style='cursor:move'> <i class="glyphicon glyphicon-arrows"></i> <?php echo e('Shorten URL') ?> (<?php echo explode(" ", $this->config["title"])[0] ?>)</a></span>
        ...
        <div class="tabbed" id="jshort">
          <div class="panel panel-default">
            <div class="panel-body text-justify">
              ...
              <p>
              <pre class="code"><span class="m-x-3">&lt;script type=&quot;text/javascript&quot;&gt;</span><span class="m-x-4">var key = &quot;<?php echo md5($this->user->api) ?>&quot;;</span><span class="m-x-3">&lt;/script&gt;<span class="m-x-3">&lt;script type=&quot;text/javascript&quot; src=&quot;<?php echo Main::href("script.js") ?>&quot;&gt;&lt;/script&gt;</span></span></pre>
              </p>
              ...
              <p>
              <pre class="code"><span class="m-x-3">&lt;script type=&quot;text/javascript&quot;&gt;</span><span class="m-x-4">var key = &quot;<?php echo md5($this->user->api) ?>&quot;;</span><span class="m-x-4">var selector = &quot;.mylink, .content > a, .comments a&quot;;</span><span class="m-x-3">&lt;/script&gt;<span class="m-x-3">&lt;script type=&quot;text/javascript&quot; src=&quot;<?php echo Main::href("script.js") ?>&quot;&gt;&lt;/script&gt;</span></span></pre>
              </p>
              ...
              <p>
              <pre class="code"><span class="m-x-3">&lt;script type=&quot;text/javascript&quot;&gt;</span><span class="m-x-4">var key = &quot;<?php echo md5($this->user->api) ?>&quot;;</span><span class="m-x-4">var exclude = [&quot;google.com&quot;,&quot;bizchain.vn&quot;];</span><span class="m-x-3">&lt;/script&gt;<span class="m-x-3">&lt;script type=&quot;text/javascript&quot; src=&quot;<?php echo Main::href("script.js") ?>&quot;&gt;&lt;/script&gt;</span></span></pre>
              </p>
              ...
              <p>
              <pre class="code"><span class="m-x-3">&lt;script type=&quot;text/javascript&quot;&gt;</span><span class="m-x-4">var key = &quot;<?php echo  md5($this->user->api) ?>&quot;;</span><span class="m-x-4">var include = [&quot;google.com&quot;];</span><span class="m-x-3">&lt;/script&gt;<span class="m-x-3">&lt;script type=&quot;text/javascript&quot; src=&quot;<?php echo Main::href("script.js") ?>&quot;&gt;&lt;/script&gt;</span></span></pre>
              </p>
          ...
          <div class="panel panel-default">
            <div class="panel-body text-justify">
              ...
              <form action="<?php echo Main::href("user/tools/zapier") ?>" method="post">
                ...
                <span class="d-flex justify-content-end"><button class="btn btn-primary" type="submit"><?php echo e("Save") ?></button></span>
              </form>
              <hr>
              ...
              <div class="panel-body text-justify">
                <h3>
                  ...
                  <?php if ($this->user->slackid) : ?>
                    <span class='d-flex align-items-center pull-right tools-status'><i class="fa fa-check-circle"></i> <?php echo e("Connected") ?></span>
                  <?php endif ?>
                </h3>
                ...
                <?php if ($this->user->slackid) : ?>
                  ...
                  <p>
                  <pre class="code">/<?php echo $this->config["slackcommand"] ?></pre>
                  </p>

                  <h5><strong><?php echo e("Example") ?></strong></h5>
                  <p>
                  <pre class="code">/<?php echo $this->config["slackcommand"] ?> https://google.com</pre>
                  </p>
                  ...
                  <p>
                  <pre class="code">/<?php echo $this->config["slackcommand"] ?> (google) https://google.com</pre>
                  </p>
                <?php else : ?>
                ...
                <?php if ($this->user->slackid) : ?>
                  <p class="d-flex justify-content-end"><a href="<?php echo Main::href("user/tools/disconnect").Main::nonce("slack") ?>" class="btn btn-danger"><?php echo e("Disconnect Slack") ?></a></p>
                <?php endif ?>
              </div>
            </div>
          </div>
